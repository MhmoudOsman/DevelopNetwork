...
public class PreferenceManager {
     ...
     */
    private static final String PREFERENCE_NAME = "com.developnetwork.sharedpreference";
    ...
    private PreferenceManager(Context applicationContext, String Preference_name) {
        gson = new Gson();
        initializeSharedPreference(applicationContext, Preference_name);
    }
    ...
    public static PreferenceManager getInstance(Context applicationContext, String Preference_name) {
        if (preferenceManager == null)
            preferenceManager = new PreferenceManager(applicationContext, Preference_name);
        return preferenceManager;
    }
    ...
    private void initializeSharedPreference(Context applicationContext, String Preference_name) {
        sharedPreferences = applicationContext.getSharedPreferences(Preference_name, Context.MODE_PRIVATE);
    }
